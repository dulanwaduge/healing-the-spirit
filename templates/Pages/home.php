...
<section class="hero-home">
    ...
    <div class="hero-content col-12 col-md-6">
        <!-- REPLACE WITH FRONTSITE CONTENT FROM DB` -->
        <h1><a style="color: white" href="<?=$this->Url->build("/appointments/add")?>"><?php echo h($content[0]->section1_title) ?>&#8594;</a></h1>
        <p><?php echo h($content[0]->section1_content) ?></p>
    </div>
    <div class="hero-img col-12 col-md-6">
        <div class="hero-img-bg">
            <?php  echo $this->Html->image(h($content[0]->section1_img), ['alt' => 'header']); ?>
            <!-- REPLACE WITH FRONTSITE CONTENT FROM DB` -->
            <img>
        </div>
    </div>
...
<section class="home-services">
    <div class="home-service-bg bg-cream ">
        <div class="bg-purple left-bg right-rad col-12 col-md-6"></div>
        <div class=" right-bg col-12 col-md-6 "></div>
    </div>
    <div class="home-service-content container">
        <div class="row">
            <div class="col-12 col-md-6 service-img">
            <?php  echo $this->Html->image(h($content[0]->section2_img), ['alt' => 'service']); ?>
            </div>
            <div class="col-12 col-md-6">
                <div class="service-text">
                    <h3><?php echo h($content[0]->section2_title) ?></h3>
                    <p><?php echo h($content[0]->section2_content) ?></p>
                    <a href="<?=$this->Url->build("/appointments/add")?>" class="custom-btn">Book an Appointment</a>
                </div>
            </div>
        </div>
...
<section class="home-services">
<div class="home-service-bg bg-cream">
    <div class=" left-bg col-12 col-md-6">
            </div>
            <div class=" right-bg bg-purple left-rad col-12 col-md-6">
        </div>
    </div>
    ...
    <div class="home-service-content container">
        ...
        <div class="col-12 col-md-6">
                <div class="service-text">
                    <h3><?php echo h($content[0]->section3_title) ?></h3>
                    <p><?php echo h($content[0]->section3_content) ?></p>
                    <a href="<?=$this->Url->build("/appointments/add")?>" class="custom-btn">Book an Appointment</a>
                </div>
            </div>
            <div class="col-12 col-md-6 service-img">
            <?php  echo $this->Html->image(h($content[0]->section3_img), ['alt' => 'service']); ?>
            </div>
...
<section class="about-section">
    <div class="container row">
    <div class="col-12 col-md-6 profile-img">
        <div class="profile-img-bg" style= "background:url('img/<?php echo h($content[0]->section4_img)?> ') center cover")>

        </div>
    </div>
    <div class="col-12 col-md-6 about-content-wrap">
        <div class="about-content">
        <h3><?php echo h($content[0]->section4_title) ?></h3>
        <p><?php echo h($content[0]->section4_content) ?></p>
        </div>
